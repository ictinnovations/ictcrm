 ...
 * 
 * @deprecated No longer used, will be removed without replacement in ICTCRM 7.12.
 */
 ...
 * @param string $min_php_version Minimum version to check against. Defaults to the ICTCRM_PHP_MIN_VERSION constant.
 * @param string $rec_php_version Recommended version. Defaults to the ICTCRM_PHP_REC_VERSION constant
 *
...
function check_php_version($sys_php_version = '', $min_php_version = '', $rec_php_version = '')
{
    ...
    if ($min_php_version === '') {
        $min_php_version = constant('ICTCRM_PHP_MIN_VERSION');
    }
    if ($rec_php_version === '') {
        $rec_php_version = constant('ICTCRM_PHP_REC_VERSION');
    }
