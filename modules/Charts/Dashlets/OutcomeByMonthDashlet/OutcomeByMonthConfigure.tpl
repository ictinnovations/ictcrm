...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input onblur="parseDate(this, '{$cal_dateformat}');" type="text" class="text" name="obm_date_start" size='12' maxlength='10' id='date_start' value='{$date_start}'>
...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input onblur="parseDate(this, '{$cal_dateformat}');" type="text" class="text" name="obm_date_end" size='12' maxlength='10' id='date_end' value='{$date_end}'>
