...
$mod_strings = array(
    ...
    'ERR_CREDENTIALS_MISSING' => 'Your ICTCRM credentials are missing.',
    ...
    'HDR_LOGIN_PANEL' => 'Please enter your ICTCRM Login credentials.',
    'HEARTBEAT_MESSAGE' => "<BR>The ICTCRM Updates mechanism allows your server to check to see if an update for your version of ICTCRM is available.",
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by ICTCRM',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the ICTCRM application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your ICTCRM application files in a .zip file, enter the following information:',
    'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
    'LBL_BACKUPS_TITLE' => 'Backups',
    'LBL_BACKUPS' => 'Backup ICTCRM files',
    'LBL_BUG_TITLE' => 'Bugs',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the ICTCRM Server.
    ...
    'LBL_DIAGNOSTIC_CONFIGPHP' => 'ICTCRM config.php',
    'LBL_DIAGNOSTIC_CUSTOMDIR' => 'ICTCRM Custom directory',
    ...
    'LBL_DIAGNOSTIC_GETSUITELOG' => 'Getting ictcrm.log',
    ...
    'LBL_DIAGNOSTIC_SUITELOG' => 'ICTCRM Log File',
    'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
    'LBL_DIAGNOSTIC_VARDEFS' => 'ICTCRM schema output (VARDEFS)',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the ICTCRM Password Management feature settings will apply.',
    ...
    'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=ICTCRM',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing ICTCRM Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Uninstalling ICTCRM Dashlet ',
    ...
    'LBL_MODULE_LOADER' => 'Add or remove ICTCRM modules, themes, language packs and other extensions',
    ...
    'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as ICTCRM updates.',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the ICTCRM Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'ICTCRM Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing ICTCRM Dashlets cache and scanning known directories for ICTCRM Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild ICTCRM Dashlets',
    ...
    'LBL_RETURN' => 'Return',
    'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to ICTCRM. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
    ...
    'LBL_SUITE_UPDATE_TITLE' => 'ICTCRM Updates',
    ...
    'LBL_UPDATE_TITLE' => 'ICTCRM Updates',
    'LBL_UPGRADE_TITLE' => 'Repair',
    'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
    'LBL_UPGRADE_WIZARD' => 'Upload and install ICTCRM upgrades',
    'LBL_UPGRADE' => 'Check and repair ICTCRM',
    ...
    'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in ICTCRM.',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of ICTCRM',
    'LBL_SUITEPORTAL' => 'ICTCRM Portal',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, ICTCRM Dashlets etc.',
    ...
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear ICTCRM Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing ICTCRM Dashlet files from cache...done',
    ...
    'LBL_QR_CBOX_CLEARSUITEFEEDCACHE' => 'Clear ICTCRM Feed Cache',
    'LBL_QR_CLEARSUITEFEEDCACHE' => 'Clearing ICTCRM Feed Cache...done',
    ...
    'ML_RELAX_LOCAL' => 'If you are running ICTCRM locally, you can relax your Module Loader restrictions to allow the package to be installed.',
    'ML_SUITE_KB' => 'ICTCRM Knowledge Base',
    'ML_SUITE_DZ' => 'ICTCRM Developer Zone',
    'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
    'ML_OVERRIDE_CORE_FILES' => 'Overriding of core ICTCRM files is not allowed ',
    ...
    'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the ICTCRM Password Management feature settings will apply.',
    ...
    'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Elasticsearch requires an external server set up to work. Read the <a href="https://docs.ictcrm.com/admin/administration-panel/search/elasticsearch/">documentation</a> to learn how.',
