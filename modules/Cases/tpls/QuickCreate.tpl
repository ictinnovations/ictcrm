...
<td>
	...
	<tr>
	<th align="left" scope="row" colspan="4"><h4><span>{$MOD.LBL_CASE_INFORMATION}</span></h4></th>
	</tr>
	<tr>
	...
	<td  nowrap><span><select  tabindex='2' name='priority'>{$PRIORITY_OPTIONS}</select></span></td>
	</tr>
	<tr>
