...
if (! defined('DOL_APPLICATION_TITLE')) define('DOL_APPLICATION_TITLE', 'ICTCRM');
if (! defined('DOL_VERSION')) define('DOL_VERSION', '1.0');		// a.b.c-alpha, a.b.c-beta, a.b.c-rcX or a.b.c
