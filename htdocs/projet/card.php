	...
	if (empty($reshook))
	{
		if ($action != "edit" && $action != 'presend' )
		{
			...
			if ($object->statut != 2)
			{
				...
				print '<div class="inline-block divButAction"><a class="butAction" href="'.DOL_URL_ROOT.'/custom/ictcore/send.php?id='.$object->id.'&amp;mode=init#ICTCore">' . 'ICTCore'.'</a></div>';
				print '<div class="inline-block divButAction"><a class="butAction" href="'.DOL_URL_ROOT.'/custom/ictcore/list.php?leftmenu=ictcampaigns&project_id='.$object->id.'">' . 'Campaigns'.'</a></div>';
			}
