 ...
 */
namespace ICTCRM\API\JsonApi\v1;

use Psr\Log\LoggerAwareInterface;
use Psr\Log\LoggerInterface;
use ICTCRM\API\JsonApi\v1\Enumerator\LinksMessage;
use ICTCRM\API\JsonApi\v1\Interfaces\JsonApiResponseInterface;
use ICTCRM\Utility\SuiteLogger as Logger;

/**
 * Class Links
 * @package ICTCRM\API\JsonApi\v1
