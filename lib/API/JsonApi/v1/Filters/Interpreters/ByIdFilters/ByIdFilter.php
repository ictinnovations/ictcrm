...
namespace ICTCRM\API\JsonApi\v1\Filters\Interpreters\ByIdFilters;

use Psr\Container\ContainerInterface;
use ICTCRM\API\JsonApi\v1\Filters\Interfaces\ByIdFilterInterpreter;
use ICTCRM\Exception\Exception;

/**
 * Class ByIdFilter
 * @package ICTCRM\API\JsonApi\v1\Filters\Interpreters\ByIdFilters
 */
